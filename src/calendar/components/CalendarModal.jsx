...
export const CalendarModal = () => {
   ...
   useEffect(() => {
    ...
    //changing= va a recibir start o end
    ...
    const onSubmit= async(event)=>{
        ...
        const difference = differenceInSeconds(formValues.dateEnd, formValues.dateStart);
...
<form className="container" onSubmit={onSubmit}>
    ...
    <div className="form-group mb-2">
        ...
        <DatePicker
            ...
            onChange={(event)=> onDateChanged(event, 'dateStart')}
